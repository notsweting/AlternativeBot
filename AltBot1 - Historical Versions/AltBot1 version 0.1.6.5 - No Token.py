...
bot_version = 'Version 0.1.6.5 [BETA]'
...
async def about (ctx):
   ...
   embed.add_field(name='Server invite', value=bot_invite)
   embed.add_field(name='Programming Language and library', value="python discord.py version 1.3.0")
...
> 
> **New stuff:**
> -Fixed Bugs 1.6.1 and 1.6.2
> 
> **In progress:**
> - Bad word detection (Will eventually be used to prevent spam pings, etc.)
> - Added YouTube notifications (Still finnicky)
''')
#whois command
@client.command()
